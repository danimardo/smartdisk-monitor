<script lang="ts">
  ...
  let { counts = { ok: 0, warn: 0, crit: 0, unknown: 0 } as Record<HealthState, number>, size = 104 } = $props();
...
<svg viewBox="0 0 120 120" width={size} height={size} role="img" aria-label="Reparto de estados de los discos monitorizados">
