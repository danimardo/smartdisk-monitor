...
**Los 15 SVG van en `mockups/icons-sprite.svg`**, listos para pegar. La hoja de contacto
`mockups/icons-hoja-de-contacto.html` los muestra a 32 / 24 / 16 / 12 px en los dos temas.
...
| `diskStack` | pila de discos | logotipo, panel general, capacidad de volumen |
