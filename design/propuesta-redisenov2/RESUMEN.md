...
```
LEEME.md                          <- por dónde empezar y tres avisos antes de tocar código
RESUMEN.md                        <- este fichero
RESPUESTAS-A-LA-REVISION.md       <- los seis puntos de la revisión, resueltos
cambios/
  00-tokens.md                    <- TODOS los cambios de token, con ratios medidos
  00b-tipografia-y-fuentes.md     <- origen, licencia y subconjunto de las fuentes
  01-panel-general.md
  02-alertas.md
  03-eventos.md
  04-pruebas.md
  ...
  07-detalle-disco.md
  08-onboarding.md
  08b-perfiles-de-alerta.md       <- los doce umbrales de los tres perfiles
...
mockups/
  ...
  icons-sprite.svg                <- los 15 iconos, listos para montar
  icons-hoja-de-contacto.html     <- los 15 a 4 tamaños, claro y oscuro
